...
const StoreDashboard = () => (
  <div>
    ...
    <img
      alt="part of my portfolio"
      src="/store-dashboard.jpg"
      style={{ width: "100%" }}
    />
    <p>
      We built a store dashboard as a trial for Co-op food stores which updates
      in real time.
    </p>
  </div>
);
...
const MPP = () => (
  <div>
    ...
    <ul>
      ...
      <li>
        Completing a time and business sensitive project to add multi language
        support to an entire CRM system to land a multi million pound deal for
        the business
      </li>
      <li>
        Custom building a cryptographic implementation to exponentially reduce
        the amount of data stored in their offers/voucher system
      </li>
      <li>
        Building out a 4 stage, high availablity infrastructure platform in a
        new amazon AWS region to facilitate new clients in the USA and Japan
      </li>
    </ul>
  </div>
);
